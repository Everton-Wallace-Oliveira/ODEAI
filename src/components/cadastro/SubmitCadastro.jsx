  ...
  function handleSubmit() {
    if (
      ...
      if (
        ...
        handlePassword(form.password, form.password2)
      ) {
        registerUser(
          form.name,
          form.email,
  ...
  function handlePassword(senha1, senha2) {
    if (senha1 == senha2) {
      if (validatePassword(senha1)) {
        ...
        handleAlert(
          true,
          'As senhas precisam ter no mínimo 8 caracteres, uma letra minúscula, uma letra maiúscula, números e caracteres especiais'
        );
      }
    } else {
