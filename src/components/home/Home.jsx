  ...
  return (
    <>
      ...
      <section className="section">
        <h1 className="mainTitle">Guia histórico de Salvador</h1>
        <p className="subtitle">
          Venha descobrir Salvador, onde a história, a cultura e a beleza
          natural se encontram de forma única. É um destino que promete
          experiências inesquecíveis, desde seu centro histórico vibrante até
        ...
        <button className="btn-ver">
          <Link to="/places" className="link-ver">
            Ver mais
          </Link>
        </button>
      </section>
