      ...
      <div className="containerHome">
        <main className="content">
          <section className="text-content">
            ...
            <p>A disciplina MATF54 - Onda EAI, oferecida pela UFBA, visa divulgar a produção acadêmica e dar voz aos estudantes indígenas da universidade.</p> 

<p>A Bahia tem a segunda maior população indígena do Brasil, com 229.103 indígenas, representando 13,5% do total de indígenas no país e 1,62% da população baiana.</p>

 <p>O objetivo do conteúdo criado é combater a visão preconceituosa de indígenas como povos primitivos, com base nas ideias de Ailton Krenak, valorizando o modo de vida indígena, incluindo os estudantes e pesquisadores da UFBA.</p>

<p>O site é uma ferramenta importante para futuras pesquisas e também pode ser usado em trabalhos acadêmicos e para a prática de saberes, tanto acadêmicos quanto os tradicionais.</p>
          </section>
